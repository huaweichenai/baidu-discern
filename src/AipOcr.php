<?php
namespace huaweichenai\discern;
/*
...
use huaweichenai\discern\lib\AipBase;
use yii\base\Component;
use yii\base\InvalidConfigException;

class AipOcr extends Component {
    ...
    {
        if ($this->appId === null) {
            throw new InvalidConfigException('百度文字识别 App ID 必填');
        } elseif ($this->apiKey === null) {
            throw new InvalidConfigException('百度文字识别 API Key 必填');
        } elseif ($this->secretKey === null) {
            throw new InvalidConfigException('百度文字识别 Secret Key 必填');
        }
    ...
    public function basicGeneral($image, $options=array()){
        ...
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->generalBasicUrl, $data);
    }
    ...
    public function basicAccurate($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->accurateBasicUrl, $data);
    }
    ...
    public function general($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->generalUrl, $data);
    }
    ...
    public function accurate($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->accurateUrl, $data);
    }
    ...
    public function enhancedGeneral($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->generalEnhancedUrl, $data);
    }
    ...
    public function webImage($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->webImageUrl, $data);
    }
    ...
    public function idcard($image, $idCardSide, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->idcardUrl, $data);
    }
    ...
    public function bankcard($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->bankcardUrl, $data);
    }
    ...
    public function drivingLicense($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->drivingLicenseUrl, $data);
    }
    ...
    public function vehicleLicense($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->vehicleLicenseUrl, $data);
    }
    ...
    public function licensePlate($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->licensePlateUrl, $data);
    }
    ...
    public function businessLicense($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->businessLicenseUrl, $data);
    }
    ...
    public function receipt($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->receiptUrl, $data);
    }
    ...
    public function form($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->formUrl, $data);
    }
    ...
    public function tableRecognitionAsync($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->tableRecognizeUrl, $data);
    }
    ...
    public function getTableRecognitionResult($requestId, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->tableResultGetUrl, $data);
    }
    ...
    public function vatInvoice($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->vatInvoiceUrl, $data);
    }
    ...
    public function qrcode($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->qrcodeUrl, $data);
    }
    ...
    public function numbers($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->numbersUrl, $data);
    }
    ...
    public function lottery($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->lotteryUrl, $data);
    }
    ...
    public function passport($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->passportUrl, $data);
    }
    ...
    public function businessCard($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->businessCardUrl, $data);
    }
    ...
    public function handwriting($image, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->handwritingUrl, $data);
    }
    ...
    public function custom($image, $templateSign, $options=array()){
        ...
        $data = array_merge($data, $options);
        $api_base = new AipBase($this->appId, $this->apiKey, $this->secretKey);
        return $api_base->request($this->customUrl, $data);
    }
